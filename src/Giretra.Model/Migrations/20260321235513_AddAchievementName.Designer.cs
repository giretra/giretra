...
namespace Giretra.Model.Migrations
{
    ...
    [Migration("20260321235513_AddAchievementName")]
    partial class AddAchievementName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Giretra.Model.Entities.BlobStore", b =>
                {
                    ...
                    b.HasKey("Key")
                        .HasName("pk_blob_store");

                    b.ToTable("blob_store", (string)null);
                });
            ...
            modelBuilder.Entity("Giretra.Model.Entities.Bot", b =>
                {
                    ...
                    b.Property<string>("AgentTypeFactory")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)")
                        .HasDefaultValue("")
                        .HasColumnName("agent_type_factory");
                    ...
                    b.Property<string>("AuthorGithubUrl")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("author_github_url");
