...
public sealed class RoomServiceTests
{
    ...
    public RoomServiceTests()
    {
        ...
        _roomService = new RoomService(_roomRepository, _gameService, _notifications, Substitute.For<IChatService>(), AiPlayerRegistry.CreateFromAssembly(), Substitute.For<ILogger<RoomService>>());
    }
